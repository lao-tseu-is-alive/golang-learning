...
func main() {
	...
	fmt.Printf("Default date +3DAYS is: %v\n", r1)
	...
	// Add 3 days
	r1 = now.Add(72 * time.Hour)
	fmt.Printf("Now date +3DAYS is: %v\n", r1)

	// Subtract 3 days
	r1 = now.Add(-72 * time.Hour)
	fmt.Printf("Now date -3HRS is: %v\n", r1)

	// More comfortable api
	// to add days/months/years
	r1 = now.AddDate(1, 3, 2)
	fmt.Printf("Now date +1YR +3MTH +2D is: %v\n", r1)
