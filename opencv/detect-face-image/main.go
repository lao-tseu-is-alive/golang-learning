...
func main() {
	...
	const model = "opencv/models/res10_300x300_ssd_iter_140000.caffemodel"
	const prototxt = "opencv/models/deploy.prototxt.txt"
	const defaultImagePath = "opencv/images/test02.jpg"
